(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/http'), require('rxjs/Observable'), require('rxjs/add/operator/switchMap'), require('rxjs/add/operator/catch'), require('rxjs/add/observable/interval'), require('rxjs/add/observable/fromEvent'), require('rxjs/add/observable/throw'), require('rxjs/add/observable/empty'), require('rxjs/add/observable/merge'), require('rxjs/add/operator/take'), require('rxjs/add/operator/map'), require('rxjs/add/operator/takeWhile'), require('rxjs/add/operator/delay'), require('rxjs/add/operator/do'), require('rxjs/add/observable/of')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/http', 'rxjs/Observable', 'rxjs/add/operator/switchMap', 'rxjs/add/operator/catch', 'rxjs/add/observable/interval', 'rxjs/add/observable/fromEvent', 'rxjs/add/observable/throw', 'rxjs/add/observable/empty', 'rxjs/add/observable/merge', 'rxjs/add/operator/take', 'rxjs/add/operator/map', 'rxjs/add/operator/takeWhile', 'rxjs/add/operator/delay', 'rxjs/add/operator/do', 'rxjs/add/observable/of'], factory) :
	(factory((global['ng2-ui-auth'] = {}),global.ng.core,global.ng.http,global.Rx));
...
var JwtHttp = /** @class */ (function () {
    ...
    JwtHttp.prototype.patch = function (url, body, options) {
        options = options || {};
        options.method = http.RequestMethod.Patch;
        options.body = body;
        return this.request(url, options);
    };
    /**
    ...
    JwtHttp.prototype.head = function (url, options) {
        options = options || {};
        options.method = http.RequestMethod.Head;
        return this.request(url, options);
    };
    /**
     * @return {?}
    ...
    JwtHttp.prototype.refreshToken = function () {
        var _this = this;
        var /** @type {?} */ authHeader = new http.Headers();
    ...
    JwtHttp.prototype.actualRequest = function (url, options) {
        if (url instanceof http.Request) {
            url.headers = url.headers || new http.Headers();
            this.setHeaders(url);
        }
        else {
            options = options || {};
    ...
    JwtHttp.prototype.setHeaders = function (obj) {
        var _this = this;
        obj.headers = obj.headers || new http.Headers();
...
var PopupService = /** @class */ (function () {
    ...
    PopupService.prototype.eventListener = function (redirectUri) {
        ...
        return Observable.Observable
            .merge(Observable.Observable.fromEvent(this.popupWindow, 'loadstart')
            ...
            if (parser.search || parser.hash) {
                ...
                if (allParams.error) {
                    ...
                    return Observable.Observable.of(allParams);
                }
            }
            return Observable.Observable.empty();
        }), Observable.Observable.fromEvent(this.popupWindow, 'exit').delay(100).map(function () { throw new Error('Authentication Canceled'); })).take(1);
    };
    /**
     * @return {?}
     */
    ...
    Oauth2Service.prototype.open = function (options, userData) {
        ...
        return openPopup
            ...
            if (_this.defaults.responseType === 'token' || !_this.defaults.url) {
                return Observable.Observable.of(oauthData);
            }
    ...
    Ng2UiAuthModule.forRootWithCustomHttp = function (config, httpProvider) {
        return {
            ...
            providers: [
                ...
                httpProvider,
                { provide: OauthService, useClass: OauthService, deps: [JwtHttp, core.Injector, SharedService, ConfigService] },
    ...
    Ng2UiAuthModule.forRoot = function (config) {
        return {
            ...
            providers: [
                ...
                { provide: StorageService, useClass: BrowserStorageService, deps: [ConfigService] },
                { provide: SharedService, useClass: SharedService, deps: [StorageService, ConfigService] },
                { provide: JwtHttp, useClass: JwtHttp, deps: [http.Http, SharedService, ConfigService] },
                { provide: OauthService, useClass: OauthService, deps: [JwtHttp, core.Injector, SharedService, ConfigService] },
                { provide: PopupService, useClass: PopupService, deps: [ConfigService] },
                { provide: Oauth1Service, useClass: Oauth1Service, deps: [JwtHttp, PopupService, ConfigService] },
                { provide: Oauth2Service, useClass: Oauth2Service, deps: [JwtHttp, PopupService, StorageService, ConfigService] },
